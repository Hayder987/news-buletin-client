      ...
      <div className="md:max-w-[900px] mx-auto relative">
        ...
        <div className="">
          ...
          <div className="absolute top-2 right-2 bg-blue-300 py-6 px-2 rounded-xl flex flex-col gap-4">
            <Link to={`/news/${_id}`}><button className="p-3 bg-indigo-600 text-white rounded-xl text-xl"><MdEdit /></button></Link>
            <button onClick={deleteHandler} className="p-3 bg-red-700 text-white rounded-xl text-xl"><MdDelete /></button>
          </div>
        </div>
        {/* comment details */}
